        ...
        <div class="col-md-10">
            ...
            <form action="<?php echo U('Home/Index/login');?>?do=chk" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name='verify' class="form-control" value=""><img src="<?php echo U('verify');?>" onClick="this.src=this.src+'?'+Math.random();" class="verifyimg reloadverify" style="vertical-align:middle; cursor: pointer;">看不清？请点击图片
                    </div>
                </div>
                <div class="form-group">
